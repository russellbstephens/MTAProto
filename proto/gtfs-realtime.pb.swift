  ...
  public struct StopTimeEvent: SwiftProtobuf.Message, SwiftProtobuf.ExtensibleMessage {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 1000..<2000:
          try decoder.decodeExtensionField(values: &_protobuf_extensionFieldValues, messageType: StopTimeEvent.self, fieldNumber: fieldNumber)
        default: break
        }
      }
    }
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
      ...
      try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
        while let fieldNumber = try decoder.nextFieldNumber() {
          ...
          case 1000..<2000:
            try decoder.decodeExtensionField(values: &_protobuf_extensionFieldValues, messageType: StopTimeUpdate.self, fieldNumber: fieldNumber)
          default: break
          }
        }
      }
  ...
  public struct Translation: SwiftProtobuf.Message, SwiftProtobuf.ExtensibleMessage {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 1000..<2000:
          try decoder.decodeExtensionField(values: &_protobuf_extensionFieldValues, messageType: Translation.self, fieldNumber: fieldNumber)
        default: break
        }
      }
    }
